...
var OPromise = /** @class */ (function (_super) {
    ...
    OPromise.prototype.resolve = function (result) {
        ...
        if (shared_1.isThenable(result)) {
            ...
            result
                ...
                .then(shared_1.noop, console.error); // tslint:disable-line
        }
        else {
    ...
    OPromise.prototype['_isCurrent'] = function (value) {
        ...
        return value && value[shared_1.$O] === this;
    };
...
function bindPromise(promise) {
    ...
    if (!observable) {
        ...
        shared_1.definePrivate(promise, shared_1.$O, observable);
    }
    return observable;
}
exports.bindPromise = bindPromise;
//# sourceMappingURL=OPromise.js.map