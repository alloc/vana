...
var createCache = function () { return Object.create(null); };
/**
...
function useKeyedMemos(input, keyof, compute) {
    ...
    var cache = use_memo_one_1.useMemoOne(createCache, [target, keyof, compute]);
    var output = use_memo_one_1.useMemoOne(function () { return (target ? target.get().map(keyedCompute(cache, keyof, compute)) : []); }, [cache]);
...
//# sourceMappingURL=useKeyedMemos.js.map