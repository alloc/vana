...
var OProps = /** @class */ (function (_super) {
    ...
    OProps.prototype['_onChange'] = function (change) {
        ...
        if (change.target !== this) {
            ...
            var nextProps = common_1.shallowCopy(currProps);
            nextProps[target.prop] = change.newValue;
            // Bind `this` to its next value.
            common_1.definePrivate(nextProps, symbols_1.$O, this);
        ...
        // Notify property observers first.
            ...
            var oldObservable = oldValue && oldValue[symbols_1.$O];
            if (newValue) {
...
var OProp = /** @class */ (function (_super) {
    ...
    OProp.prototype._observeValue = function (value) {
        ...
        var observed = value && value[symbols_1.$O];
        if (observed) {
...
function bindProps(root) {
    ...
    common_1.definePrivate(root, symbols_1.$O, rootObservable);
        ...
        Object.keys(parent).forEach(function (prop) {
            ...
            if (common_1.isObject(value)) {
                ...
                if (!observable) {
                    ...
                    common_1.definePrivate(value, symbols_1.$O, observable);
