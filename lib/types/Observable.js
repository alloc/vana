...
var Observable = /** @class */ (function () {
    ...
    Observable.from = function (value) {
        return value instanceof Observable ? value : value ? value[symbols_1.$O] : undefined;
    };
    /** The current value. */
    ...
    Observable.prototype.tap = function (onUpdate) {
        ...
        var observer = {
            ...
            _onChange: function (change) { return change.prop !== null || onUpdate(change.newValue); },
        };
    ...
    Observable.prototype['_onChange'] = function (change) {
        ...
        if (debug_1.getDebug(this)) {
            ...
            console.debug('%s(%s) changed: (observers: %O, change: %O)', this.constructor.name, this.id, observers ? observers.length : 0, common_1.shallowCopy(change) // TODO: Deep copy instead
            );
        }
        if (observers) {
    ...
    Observable.prototype['_rebind'] = function (source) {
        this._get = typeof source == 'function' ? source : undefined;
...
function isObservable(value) {
    if (value) {
        var observable = value[symbols_1.$O];
        if (observable) {
